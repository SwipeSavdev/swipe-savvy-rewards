...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "permissions", postgresql.ARRAY(sa.String()), nullable=False, server_default="{}"
        ),
        sa.Column("status", sa.String(50), nullable=False, server_default="active"),
        sa.Column("last_login", sa.DateTime(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        "ix_merchant_onboardings_ext_ref_id", "merchant_onboardings", ["ext_ref_id"], unique=True
    )
    ...
    op.create_index(
        "ix_notification_history_notification_type", "notification_history", ["notification_type"]
    )
    ...
    op.create_index(
        "ix_notification_history_message_id", "notification_history", ["message_id"], unique=True
    )
    ...
    op.create_index(
        "ix_notification_templates_name", "notification_templates", ["name"], unique=True
    )
