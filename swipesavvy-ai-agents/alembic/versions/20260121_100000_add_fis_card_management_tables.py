...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        ),  # pending, active, locked, frozen, cancelled, expired
    ...
    op.create_table(
        ...
        sa.Column(
            "card_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("fis_cards.id", ondelete="CASCADE"),
            nullable=False,
            unique=True,
        ),
        # Spending limits
    ...
    op.create_table(
        ...
        ),  # otp, security_questions, biometric
    ...
    op.create_table(
        ...
        ),  # purchase, refund, atm_withdrawal, etc.
    ...
    op.create_index(
        "ix_fis_transactions_fis_transaction_id", "fis_transactions", ["fis_transaction_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "wallet_type", sa.String(50), nullable=False
    ...
    op.create_table(
        ...
        sa.Column(
            "verification_type", sa.String(50), nullable=False
        ),  # identity, document, ofac, address
        sa.Column(
