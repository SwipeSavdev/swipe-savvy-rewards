...
class ContentSafetyChecker:
    ...
    PATTERNS = {
        "violence": {
            "patterns": [r"\b(kill|murder|harm|hurt|attack|assault|weapon|gun|knife|threat)\b"],
            "severity": "high",
        },
        "hate_speech": {
            "patterns": [r"\b(hate|racist|discrimination|bigot)\b"],
            "severity": "critical",
        },
        "self_harm": {
            "patterns": [r"\b(suicide|self-harm|end my life|kill myself)\b"],
            "severity": "critical",
        },
        "profanity": {"patterns": [r"\b(damn|hell|stupid|idiot|moron|dumb)\b"], "severity": "low"},
        "toxic": {
            "patterns": [
...
async def root():
    ...
    return {
        ...
        "endpoints": ["GET /health", "POST /api/v1/guardrails/check"],
    }
