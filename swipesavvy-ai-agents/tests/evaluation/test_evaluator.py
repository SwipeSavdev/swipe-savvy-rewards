...
def test_handoff_cases_present():
    ...
    # Find handoff cases
    handoff_cases = [tc for tc in test_cases if tc["expected_output"].get("should_handoff", False)]
    ...
    expected_reasons = {"human_request", "frustration", "complex_topic", "high_value_transaction"}
