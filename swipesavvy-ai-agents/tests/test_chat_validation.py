...
class TestChatRequest:
    ...
    def test_chat_message_too_long(self):
        ...
        with pytest.raises(ValueError, match="max_length"):
            ChatRequest(message="x" * 3000, user_id="valid_user_123", session_id="session_456")

    def test_chat_message_empty(self):
        """Empty message should be rejected"""
        with pytest.raises(ValueError, match="at least 1"):
            ChatRequest(message="", user_id="valid_user_123", session_id="session_456")
    ...
    def test_chat_session_id_too_short(self):
        ...
        with pytest.raises(ValueError, match="ensure this value has at least 10 characters"):
            ChatRequest(message="Hello", user_id="valid_user_123", session_id="sess")  # Too short
...
class TestSignupRequest:
    ...
    def test_signup_invalid_email(self):
        ...
        with pytest.raises(ValueError):
            SignupRequest(
                email="not-an-email", password="SecurePass123!", first_name="John", last_name="Doe"
            )
...
class TestTransactionRequest:
    ...
    def test_transaction_valid(self):
        ...
        request = TransactionRequest(
            amount=100.50, transaction_type="transfer", description="Payment to John"
        )
    ...
    def test_transaction_negative_amount(self):
        ...
        with pytest.raises(ValueError, match="greater than 0"):
            TransactionRequest(amount=-50, transaction_type="transfer")

    def test_transaction_zero_amount(self):
        """Zero amount should be rejected"""
        with pytest.raises(ValueError, match="greater than 0"):
            TransactionRequest(amount=0, transaction_type="transfer")

    def test_transaction_amount_too_large(self):
        """Amount exceeding maximum should be rejected"""
        with pytest.raises(ValueError, match="less than or equal to"):
            TransactionRequest(amount=2000000, transaction_type="transfer")  # Exceeds 1M limit
    ...
    def test_transaction_invalid_type(self):
        ...
        with pytest.raises(ValueError, match="deposit|withdrawal|transfer|payment|refund"):
            TransactionRequest(amount=100, transaction_type="invalid_type")
...
class TestCreateAccountRequest:
    ...
    def test_create_account_valid(self):
        ...
        request = CreateAccountRequest(
            account_type="checking", account_name="Main Checking", initial_balance=1000
        )
...
class TestValidationIntegration:
    ...
    def test_command_injection_attempt(self):
        ...
        with pytest.raises(ValueError, match="harmful"):
            ChatRequest(message="; rm -rf /", user_id="valid_user_123", session_id="session_456")
