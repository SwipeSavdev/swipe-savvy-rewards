...
class SNSPushNotificationService:
    ...
    def register_device(
        self, user_id: UUID, device_token: str, device_type: str, device_name: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def send_notification(
        ...
        try:
            ...
            response = self.sns_client.publish(
                TargetArn=endpoint_arn, Message=message_structure, MessageStructure="json"
            )
    ...
    def send_multicast(
        self, endpoint_arns: List[str], title: str, body: str, data: Optional[Dict[str, str]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def send_event_notification(
        self, endpoint_arns: List[str], event_type: str, event_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def _format_android_message(
        title: str, body: str, data: Optional[Dict[str, str]] = None, sound: str = "default"
    ) -> str:
        """Format message for Android (GCM/FCM)."""
        message = {
            "default": body,
            "GCM": json.dumps(
                {"notification": {"title": title, "body": body, "sound": sound}, "data": data or {}}
            ),
        }
        return json.dumps(message)
...
class NotificationPreferencesService:
    ...
    def set_preferences(
        self, user_id: UUID, preferences: Dict[str, bool], db_session: Session
    ) -> Dict[str, Any]:
        """
    ...
    def check_notification_allowed(
        self, user_id: UUID, notification_type: str, db_session: Session
    ) -> bool:
        """
