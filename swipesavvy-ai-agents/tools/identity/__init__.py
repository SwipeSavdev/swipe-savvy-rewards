...
async def initiate_verification(
    user_id: str, session_id: str, verification_type: str = "sms_otp"
) -> Dict[str, Any]:
    """
...
async def verify_code(verification_id: str, code: str, session_id: str) -> Dict[str, Any]:
    """
    Verify OTP code
...
async def check_verification_status(user_id: str, session_id: str) -> Dict[str, Any]:
    """
    ...
    return {"is_verified": False, "verified_at": None, "expires_at": None}
